            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-[10vh] -translate-x-1/2 w-full max-w-md bg-[#111a22] border border-[#233648] rounded-2xl shadow-2xl z-[101] overflow-hidden flex flex-col max-h-[80vh]"
                    >
